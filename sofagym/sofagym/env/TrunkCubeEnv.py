# -*- coding: utf-8 -*-
"""Specific environment for the trunk, aiming to push a cube. 
...
class TrunkCubeEnv(AbstractEnv):
    ...
    DEFAULT_CONFIG = {"scene": "TrunkCube",
                      "deterministic": True,

                      "source": [350, 0, 400], #[450, 0, 80],
                      "target": [0, 0, 0], #[0, 0, 80],
                      #"goalList": [[40, -60, 200], [-10, 20, 80]],
                      "goalList": [[100.0, -100.0, 50.0]],
                      #"goalList": None, 
                      ...
                      "save_video": True,
                      "save_image": False,
                      "save_path": path + "/Results" + "/TrunkCube",
                      "planning": False,
                      "discrete": True,
                      "seed": None,
    ...
    def __init__(self, config_ext_dict = None, unmodeled=False):
        if unmodeled:
            config_path = os.path.dirname(os.path.abspath(__file__)) + "/TrunkCube/TrunkCube_random_unmodeled_config.json"
        else:
            config_path = os.path.dirname(os.path.abspath(__file__)) + "/TrunkCube/TrunkCube_random_config.json"
...
register(
    id='trunkcube-v0',
    entry_point='sofagym.env:TrunkCubeEnv',
)
