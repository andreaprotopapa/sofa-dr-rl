...
class SofaPrefab(object):
    ...
    def __call__(self, *args, **kwargs):
            ...
            frameinfo = getframeinfo(currentframe().f_back)
            o.node.addData(name="Prefab type", group="Infos", value="", default="", type="string", help=str(o.__class__.__name__))
            o.node.addData(name="modulepath", group="Infos", type="string", default="",
                              value=str(os.path.dirname(os.path.abspath(sys.modules[o.__module__].__file__))), help="")
            o.node.addData(name="Defined in", group="Infos", help="", default="", type="string", value=str(self.definedloc))
            o.node.addData(name="Instantiated in", group="Infos", help="",default="", type="string", value=str((frameinfo.filename, frameinfo.lineno)))
            o.node.addData(name="Help", group="Infos", help="", default="", type="string", value=str(getdoc(o)))
