#%% Imports
from src.data.hopper_data_generator import HopperDataGenerator
...
g = HopperDataGenerator(demo_file=args.dataset, load_from_file=False,
...
if args.true_dist:
    ...
    dist_posterior = get_results_from_current_dist(env_params=[f"m{i}" for i in range(4)],
        true_obs=true_obs, generator=g, inf=inf_mdn, shapes=shapes,
        p_lower=g.env.min_task, p_upper=g.env.max_task, env_name="hopper_wrong_mass",
        dyn_samples=200)
