...
Examples:
	...
	[Quick test] python3 test_dropo.py --env RandomMassHopper-v0 --sparse-mode -n 10 -l 1 --budget 1000 -av --epsilon 1e-5 --seed 100 --dataset datasets/hopper10000 --normalize --logstdevs

	[Advanced test] python3 test_dropo.py --env RandomMassHopper-v0 -n 2 -l 1 --budget 5000 -av --epsilon 1e-5 --seed 100 --dataset datasets/hopper10000 --normalize --logstdevs --now 10

	[Unmodeled environment test] python3 test_dropo.py --env RandomFixedMassHopper-v0 -n 2 -l 1 --budget 5000 -av --epsilon 1e-3 --seed 100 --dataset datasets/hopper10000 --normalize --logstdevs --now 10
